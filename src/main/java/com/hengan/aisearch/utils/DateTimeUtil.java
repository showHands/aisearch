...
public class DateTimeUtil {
	 ...
	 * @return
	 */
	public static boolean betweenDate(String curentDateStr, String startDateStr, String endDateStr) {
		try {
			Date curDate = getStrToDate(curentDateStr, DATE_FORMAT_NORMAL) ;
			Date startDate = getStrToDate(startDateStr, DATE_FORMAT_NORMAL) ;
			Date endDate = getStrToDate(endDateStr, DATE_FORMAT_NORMAL) ;
	 ...
	 * ldl 20181123
	 */
	public static String getTimeStrBySpecPattern(Date date, String pattern) {
    ...
    public static int yearsBetween(String start, String end) throws ParseException {
        startDate.setTime(sdfTime.parse(start));
        endDate.setTime(sdfTime.parse(end));
...
//		System.out.println(getIntervalDaysLater(getNowDateNormalString(),2));
		...
		*/
		System.out.println(getDateDotString(new Date()));
	}
